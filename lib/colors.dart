...
class AppColor{
  ...
  static Color homePageTitle=const Color(0xFF392f51);
  ...
  static Color homePageContainerTextSmall=const Color(0xffe3e3ea);
  ...
  static Color secondPageContainerGradient1stColor=const Color(0x43dee3fc);
  static Color secondPageContainerGradient2stColor=const Color(0x32d8dbea);
  static Color secondPageIconColor=const Color(0xffb7bce8);
  static Color loopColor=const Color(0xff6d8dea);
  static Color restColor=const Color(0x8adbdeec);
